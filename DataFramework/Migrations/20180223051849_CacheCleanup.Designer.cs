...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataFramework.Models.DataContext.Die", b =>
                {
            ...
            modelBuilder.Entity("DataFramework.Models.DataContext.DieFace", b =>
                {
            ...
            modelBuilder.Entity("DataFramework.Models.DataContext.DieFaceSymbol", b =>
                {
                    b.Property<int>("DieFaceId");
            ...
            modelBuilder.Entity("DataFramework.Models.DataContext.Pool", b =>
                {
            ...
            modelBuilder.Entity("DataFramework.Models.DataContext.PoolCombination", b =>
                {
            ...
            modelBuilder.Entity("DataFramework.Models.DataContext.PoolDie", b =>
                {
                    b.Property<long>("PoolId");
            ...
            modelBuilder.Entity("DataFramework.Models.DataContext.PoolResult", b =>
                {
            ...
            modelBuilder.Entity("DataFramework.Models.DataContext.PoolResultSymbol", b =>
                {
                    b.Property<long>("PoolResultId");
            ...
            modelBuilder.Entity("DataFramework.Models.DataContext.DieFace", b =>
                {
                    b.HasOne("DataFramework.Models.DataContext.Die", "Die")
                        .WithMany("DieFaces")
                        .HasForeignKey("DieId")
            ...
            modelBuilder.Entity("DataFramework.Models.DataContext.DieFaceSymbol", b =>
                {
                    b.HasOne("DataFramework.Models.DataContext.DieFace", "DieFace")
            ...
            modelBuilder.Entity("DataFramework.Models.DataContext.PoolCombination", b =>
                {
                    b.HasOne("DataFramework.Models.DataContext.Pool", "NegativePool")
                        .WithMany("NegativePoolCombinations")
                        .HasForeignKey("NegativePoolId");

                    b.HasOne("DataFramework.Models.DataContext.Pool", "PositivePool")
            ...
            modelBuilder.Entity("DataFramework.Models.DataContext.PoolDie", b =>
                {
                    ...
                    b.HasOne("DataFramework.Models.DataContext.Pool", "Pool")
                        .WithMany("PoolDice")
            ...
            modelBuilder.Entity("DataFramework.Models.DataContext.PoolResultSymbol", b =>
                {
                    b.HasOne("DataFramework.Models.DataContext.PoolResult", "PoolResult")
